...
public class Fraction {
    ...
    /**
     * This code {@code add} will be executed to add fractions. This method utilizes another methods named
     * {@code computeLCD} and {@code makeSimilar}. These methods are essential to execute and perform addition
    ...
    /**
     * This code {@code subtract} will be executed to add fractions. This method utilizes another methods named
     * {@code computeLCD} and {@code makeSimilar}. These methods are essential to execute and perform subtraction
     * operation successfully.
     * @param another
     * @return new Fraction
     */
    ...
    /**
     * This method {@code computeLCD} will compute the least common denominator to make dissimilar fractions similar
     * It is used in another method {@code makeSimilar}
     */
    ...
    /**
     * This method {@code makeSimilar}will help convert fractions so that two fractions will be similar
     * with the help of {@code computeLCD} from the previous method
     */
    ...
    /**
     * This method {@code toMixedFraction} makes and converts the fraction to mixed fraction if applicable
     * This method is utilized specifically for {@code multiplyBy} and {@code divideBy} because we need first
     * the improper fraction to execute the operation. The resulting product or quotient will be converted again
     * to mixed fraction, thus the creation of this method.
     *
